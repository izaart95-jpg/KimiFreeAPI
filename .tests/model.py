...
if __name__ == "__main__":
    chat_id, last_message_id = start_new_chat("in this sytem i got loophole 🪙 Coin Flip Hell (LOW RISK) Command: +coinflip <amount> (or +cf, +coin, +flip) Odds: 40% chance to win Payout: 2x your bet Loss: 2x your bet (60% chance) u do math if i got 2 accounts 1 with 50 credits second with 0 bot one do +cf 25 but to get heck of penalty before +cf 25 it will send all oter credits to bot 2 so it wont have to pay penalty  after if lose got penalty but since it only had 25 ehich he betted theres 0 double side loss  if win  then send half of redits to bot 2 and try  means bot 2 bank  now do math and tell me  with 10 gambling bots and 1 bank starting with 50 credits each bot whats my cance to get 1000 credits and estimated how much time im not talking orobabilty just chance ")
    print("\n\nDONE")
